#region License
// AnkiSyncException.cs is part of ReadingTool.Common
// 
...
namespace ReadingTool.Common.Anki
{
    ...
    {
        public AnkiSyncException()
            : base()
        {

        }

        public AnkiSyncException(string message)
            : base(message)
        {

        }

        public AnkiSyncException(string message, Exception e)
            : base(message, e)
        {
