#region License
// SubtitleParsingException.cs is part of ReadingTool.Common
// 
...
{
    public class SubtitleParsingException : Exception
    {
        public SubtitleParsingException()
            : base("Could not parse SRT file")
        {
        }
