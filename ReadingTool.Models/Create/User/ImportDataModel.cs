#region License
// ImportDataModel.cs is part of ReadingTool.Models
// 
...
namespace ReadingTool.Models.Create.User
{
    public class ImportExportDataModel
    {
        ...
        public IEnumerable<SystemLanguage> SystemLanguages { get; set; }
        public IEnumerable<Entities.Language> Languages { get; set; }
        public IEnumerable<Item> Items { get; set; }
        public IEnumerable<Entities.Word> Words { get; set; }
