#region License
// TextModel.cs is part of ReadingTool.Models
// 
...
namespace ReadingTool.Models.Create.Text
{
    public class TextModel
    {
        ...
        [Help("Use this option to group texts into collections.")]
        ...
        [Help("The URL of the audio for this text, currently only MP3 is supported. It must start with <u>http://</u><br/>Please do not hotlink to other peoples files without permission. " +
        ...
        [Help("If you want to share your texts with groups, but not the URL of the audio check this box.")]
        ...
        public string ParseWith { get; set; }
