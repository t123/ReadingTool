#region License
// MessageModel.cs is part of ReadingTool.Models
// 
...
namespace ReadingTool.Models.Create.Message
{
    public class MessageModel
    {
        [Required]
        [Help("This is who you'd like to send the message to. Multiple users are OK.")]
