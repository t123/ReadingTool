#region License
// Messages.cs is part of ReadingTool
// 
...
namespace ReadingTool.Common
{
    ...
    {
        public const string FormValidationError = @"Please correct the errors below";
        public const string SignInError = @"Please check your username and password";
    }
}
