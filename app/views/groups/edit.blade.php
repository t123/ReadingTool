...
@section('pageTitle')
Languages - Edit Group
@stop

@section('content')
{{ Form::model($group, array('action'=>array('GroupController@postEdit', $group->id), 'class'=>'form-horizontal', 'role'=>'form')) }}
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        ...
        <a href="{{ action("GroupController@membership", $group->id) }}" class="btn btn-default">
            Edit membership
        </a>
        <a href="{{ action("GroupController@texts", $group->id) }}" class="btn btn-default">
            View texts
        </a>
    </div>
</div>
