    ...
    <body>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ul class="nav nav-pills">
                        ...
                        @if($nextId!=null)
                        <li class="pull-right">
                            <a href="{{ action($readAction, array($groupId, $nextId)) }}">
                                next
                            </a>
                        </li>
                        @endif
                        <li style="margin-top: 2px;" class="pull-right">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{ action("GroupController@texts", array($groupId)) }}">back to group</a>
                                        <a href="{{ action("GroupController@read", array($groupId, $text->id)) }}">read single mode</a>
                                        @if($text->l2_id!=null)
                                        ...
                                        @endif
                                        @if($previousId!=null)
                                            <a href="{{ action("GroupController@read", $previousId) }}">previous text</a>
                                        @endif
                        ...
                        @if($previousId!=null)
                        <li class="pull-right">
                            <a href="{{ action($readAction, array($groupId, $previousId)) }}">
                                previous
                            </a>
                        </li>
                        @endif
        ...
        <div id="readingareaouter">
            ...
            <div style="background-color: #fff; padding-left:15px;">
                <div class="clr50"></div>
                @if($previousId!=null)
                    <a href="{{ action($readAction, array($groupId, $previousId)) }}" class="btn btn-default">previous text</a>
                @endif
                @if($nextId!=null)
                    <a href="{{ action($readAction, array($groupId, $nextId)) }}" class="btn btn-default">next text</a>
                @endif
                <div class="clr10"></div>
