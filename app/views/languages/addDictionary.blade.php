...
@section('content')
{{ Form::open(array('action'=>array('LanguageController@postAddDictionary', $language->id), 'class'=>'form-horizontal', 'role'=>'form')) }}
<legend>Add Dictionary to {{ $language->name }}</legend>
