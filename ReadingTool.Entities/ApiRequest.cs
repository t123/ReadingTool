#region License
// ApiRequest.cs is part of ReadingTool.Entities
// 
...
namespace ReadingTool.Entities
{
    ...
    {
        public const string CollectionName = @"APIRequests";

        public const int PER_HOUR = 50;
        public const int PER_DAY = 250;

        [BsonId]
        public ObjectId ApiRequestId { get; set; }
