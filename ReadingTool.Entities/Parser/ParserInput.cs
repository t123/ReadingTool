#region License
// ParserInput.cs is part of ReadingTool.Entities
// 
...
namespace ReadingTool.Entities.Parser
{
    public class ParserInput
    {
        ...
        public Tuple<ParsingWord[], ParsingWord[]> Words { get; set; }

        public ParserInput(
            User user,
            Language language,
            Item item,
            Tuple<ParsingWord[], ParsingWord[]> words,
            bool? asParallel
            )
        {
            Language = language;
